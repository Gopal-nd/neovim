...
return {
  ...
  config = function()
      require("neo-tree").setup({
          ...
          filesystem = {
              follow_current_file = {
                  enabled = true,         -- Automatically reveal the file you're currently editing
                  leave_dirs_open = false, -- Close non-relevant directories
              },
              filtered_items = {
                  hide_dotfiles = false,   -- Show dotfiles in the file explorer
          ...
          buffers = {
              follow_current_file = {
                  enabled = true,         -- Automatically reveal the current file in the buffers list
              },
          },
